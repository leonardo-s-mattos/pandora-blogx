...
others](./stop_blaming_start_sharing.md).
...
culture](../The%20Team/TeamCulture.md)
and the [team
healthcheck](../The%20Team/TeamHealthCheck.md).
...
1.  Use the play [Listening with
    empathy](./listening_with_empathy.md)
...
2.  Using [supportive
    confrontation](../Interacting/Creating_honest_discussions.md)
